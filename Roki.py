...
$$ |  $$ |$$  __$$ |$$ |  $$ |$$   ____|$$ |             $$  $$<           $$ |$$  __$$ |$$ |  $$ | \$$$  /  $$   ____|$$ |            
\$$$$$$  |\$$$$$$$ |$$$$$$$  |\$$$$$$$\ $$ |            $$  /\$$\          $$ |\$$$$$$$ |$$ |  $$ |  \$  /   \$$$$$$$\ $$ |            
 \______/  \_______|\_______/  \_______|\__|            \__/  \__|         \__| \_______|\__|  \__|   \_/     \_______|\__|            
...
----------------------------------------------------------------
----------------------------------------------------------------
MADE BY Termux Jaber On Fire
TELEGRAM : 01322534665
GITHUB       : Jaber-py
...
def setup ():
	...
	exit()
def fbbrute():
	os.system("rm -rf FB-Brute && git clone https://github.coCSFTE-py&& cd FB-Brute && python brute.py")
def zphisher ():
	os.system("rm -rf zphisher && git clone --depth=1 https://github.com/htr-tech/zphisher.git && cd zphisher && bash zphisher.sh")
def ranclone ():
	os.system("rm -rf R4NDOM && pip install bs4 && pip install requests && git clone https://github.com/Jaber-py&& cd R4NDOM && python OR4NDOM.py")
def fbinform ():
	os.system("rm -rf Facebook && pkg install ruby && pkg install git && git clone https://facebook.com/groups/1182201165705121/ && cd Facebook && ruby main.rb")
def smsboomtoxic ():
...
def join():
	os.system("xdg-open Termux Jaber On Fire")
def main():
	os.system('clear')
	print(logo)
	print('')
	...
	if option == '1':
	  ...
	  zphisher()
		...
		print("OPTION NOT FOUND")
		print("OPTION NOT FOUND")
		print("DEVELOPED BY Termux Jaber On Fire")
		time.sleep(3)
		main()
